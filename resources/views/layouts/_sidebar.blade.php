...
@hasanyrole('Admin|Super Admin')
        ...
        <li class="nav-item">
            <a class="nav-link {{ Route::is('incoming-goods*') ? 'active' : '' }}"
        ...
        <li class="nav-item">
    <a class="nav-link {{ Route::is('admin.outgoing-goods*') ? 'active' : '' }}"
        href="{{ route('admin.outgoing-goods.index') }}">
        <span class="nav-link-icon d-md-none d-lg-inline-block mr-1">
